        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareerLevel = table.Column<int>(type: "int", nullable: true),
                    ...
                    RecruiterRole = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiProcessedDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_AspNetUsers_CreatedByRecruiterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivitiesSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AiGeneratedCvPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assessments_JobPosts_JobPostId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedJobs_AspNetUsers_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecruiterRating = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Answers = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateAssessment_Assessment",
                        column: x => x.AssessmentId,
                        principalTable: "Assessments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CandidateAssessment_Candidate",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateAssessment_JobApplication",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiQuestions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AiTranscript = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Score = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assessments_JobPostId",
                table: "Assessments",
                column: "JobPostId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateAssessment_AssessmentId",
                table: "CandidateAssessments",
                column: "AssessmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateAssessment_Candidate_Assessment_Unique",
                table: "CandidateAssessments",
                columns: new[] { "CandidateId", "AssessmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CandidateAssessment_CandidateId",
                table: "CandidateAssessments",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateAssessment_IsCompleted",
                table: "CandidateAssessments",
                column: "IsCompleted");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateAssessment_JobApplicationId",
                table: "CandidateAssessments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_CreatedByRecruiterId",
                table: "JobPosts",
                column: "CreatedByRecruiterId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_IsPublished_IsActive_ExpiryDate",
                table: "JobPosts",
                columns: new[] { "IsPublished", "IsActive", "ExpiryDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resumes_CandidateId_IsDefault",
                table: "Resumes",
